...
fn calculate_loyalty_multiplier_should_work() {
    let testing_values = vec![
        ...
        (
            ...
            FixedU128::from_inner(1_000_000_000_000_000_000), //1
            FixedU128::from_inner(160_097_499_999_999_999),   //0.1600975
            FixedU128::from_inner(62_499_999_999_999_999),    //0.0625
        ),
        (
            4,
            FixedU128::from_inner(519_230_769_230_769_230), //0.5192307692
            FixedU128::from_inner(1_000_000_000_000_000_000), //1
            FixedU128::from_inner(253_419_999_999_999_999), //0.25342
            FixedU128::from_inner(210_526_315_789_473_683), //0.2105263158
        ),
        (
            130,
            FixedU128::from_inner(782_608_695_652_173_912), //0.7826086957
            FixedU128::from_inner(1_000_000_000_000_000_000), //1
        ...
        (
            4400,
            FixedU128::from_inner(988_888_888_888_888_888), //0.9888888889
            FixedU128::from_inner(1_000_000_000_000_000_000), //1
